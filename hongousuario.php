<?php
    ...
    $row = $result->fetch_assoc();
     ...
     $query="SELECT * FROM hongos WHERE id = '$idUsuario' and status = 'A'";
...
echo $resultados;
          ...
          <div class="section">
            ...
            <p class="caption">En este panel podra ver los los hongos que an sido aprovados por los administradores y registrados en la pagina.</p>
            <div class="divider"></div>
            
            <!--DataTables example-->
            <div id="table-datatables">
              <h4 class="header">Hongos aprobados</h4>
              ...
              <div class="row">
                ...
                <div class="col s12 m8 l12">
                  <table id="data-table-simple" class="display" cellspacing="0">
                    ...
                    <tr>
                       <td><a href="hongo.php?Id_hongo=<?php echo $row['Id_hongo'];?>"><?php echo $row['Id_hongo'];?>
                       </td>
                        <td>
                         <?php echo $row['Reino'];?>
                       </td>
