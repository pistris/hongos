<?php
  ...
  if(!empty($_POST))
  {
    ...
    if($rows > 0) {
      ...
      copy($_FILES['imagen']['tmp_name'], "imgperfil/".$idImagen.'.'.$info_img['extension']);
      if($resultUsuario>0)
      $bandera = true;
      else
...
<head>
  ...
  <script>
        ...
        function validarImg()
      {
        ...
        if( valor == null || valor.length == 0 || /^\s+$/.test(valor) ) {
          alert('Falta seleccionar fot de perfil');
          return false;
        } else { return true;}
      }
      ...
      function validar()
      {
        if(validarNombre() && validarUsuario() && validarPassword() && validarTipoUsuario() && validarImg())
        {
...
echo $resultados;
        ...
        <div class="container">
          <div class="section">
            <h1 class="breadcrumbs-title">Registrar Usuario</h1>
      ...
      <?php }else{ ?>
      <br />
      <div style = "font-size:16px; color:#cc0000;"><?php echo $errors; ?></div>
    ...
    <?php } ?>
          ...
          <div class="row">
            <div class="col s12 m12 l12">
              <div class="card-panel">
                <h4 class="header2">Rellene los campos para agregar un nuevo usuario</h4>
                <div class="row">
                  <form class="col s12" id="registro" name="registro" action="<?php $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data" >
                    <div class="row">
                    ...
                    <div class="row">
                      <div class="input-field col s6">
                        <select id="tipo_usuario" name="tipo_usuario">
                          <option value="0" disabled selected>Perfil</option>
          ...
          <?php }?>
                      ...
                      <div class="file-field input-field col s6">
                        <input class="file-path validate" id="imagen" type="text"/>
                        <div class="btn">
                          <span>Foto</span>
                    ...
                    <div class="row">
                      <div class="row">
                        <div class="input-field col s12">
                          <button class="btn cyan waves-effect waves-light right" type="button" name="registrar" value="Registrar" onClick="validar();">Submit
                            <i class="mdi-content-send right"></i>
                          </button>
                        </div>
                      </div>
