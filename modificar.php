          ...
          <div class="row">
            <div class="col s12 m12 l12">
              <div class="card-panel">
                ...
                <div class="row">
                  <form class="col s12" name="modificar_usuario" method="POST" action="mod_usuario.php" >
<?php while($row = $resultado->fetch_assoc()){ ?>
                   <input type="hidden" name="id" value="<?php echo $id; ?>"> 
                     <div class="row">
                      ...
                      <div class="input-field col s6">
                        <input id="apellidos" type="text" name="apellidos" value="<?php echo $row['apellidos']; ?>">
                        <label for="last_name">Apellido</label>
                      </div>
                    </div>
                    <div class="row">
                      <div class="input-field col s12">
                        <input id="institucion" name="institucion" type="text" value="<?php echo $row['institucion']; ?>">
                        <label for="password">Institucion</label>
                      </div>
                    </div>
                   <div class="row">
                      <div class="input-field col s12">
                        <input id="correo" name="correo" type="email" value="<?php echo $row['correo']; ?>" >
                        <label for="email">Email</label>
                      </div>
                    </div>
                    <?php }?>
