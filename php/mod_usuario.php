<?php 
 ...
 require('php/conexion.php');
  ...
  $correo=$_POST['correo'];
	...
	$query="UPDATE personal SET nombre='$nombre', apellidos='$apellidos', institucion='$institucion', correo='$correo' WHERE id='$id'";
              ...
              <li class="user-details cyan darken-2">
                  <div class="row">
                      ...
                      <div class="col col s8 m8 l8">
                          ...
                          <a class="btn-flat dropdown-button waves-effect waves-light white-text profile-btn" href="#" data-activates="profile-dropdown"><?php echo ($row['nombre']); ?><i class="mdi-navigation-arrow-drop-down right"></i></a>
