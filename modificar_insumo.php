...
//COnsulta para traer la informacion del usuario
      $id=$_GET['id'];
      $query="SELECT * FROM insumo WHERE id_insumo='$id'";
          ...
          <div class="row">
            <div class="col s12 m12 l12">
              <div class="card-panel">
                ...
                <div class="row">
                  <form class="col s12" name="modificar_usuario" method="POST" action="mod_insumo.php" >
<?php while($row = $resultado->fetch_assoc()){ ?>
                   <input type="hidden" name="id" value="<?php echo $id; ?>"> 
                     <div class="row">
                      ...
                      <div class="input-field col s6">
                        <input id="descripcion" type="text" name="descripcion" value="<?php echo $row['descripcion']; ?>">
                        <label for="first_name">descripcion</label>
                      </div>
                    
                      <div class="input-field col s6">
                        <input id="medida" type="text" name="medida" value="<?php echo $row['medida']; ?>">
                        <label for="last_name">medida</label>
                      </div>
                    
                    <div class="input-field col s6">
                        <input id="color" type="text" name="color" value="<?php echo $row['color']; ?>">
                        <label for="last_name">color</label>
                      </div>
                    
                    <div class="input-field col s6">
                        <input id="unidad" type="text" name="unidad" value="<?php echo $row['unidad']; ?>">
                        <label for="last_name">unidad</label>
                      </div>
                   
                    <div class="input-field col s6">
                        <input id="familia" type="text" name="familia" value="<?php echo $row['familia']; ?>">
                    ...
                    <div class="input-field col s6">
                        <input id="observaciones" type="text" name="observaciones" value="<?php echo $row['observaciones']; ?>">
                    ...
                    <div class="row">
                      <div class="row">
                        <div class="input-field col s12">
                          <button class="btn cyan waves-effect waves-light right" type="submit" name="Guardar" value="Guardar" >Submit
                            <i class="mdi-content-send right"></i>
